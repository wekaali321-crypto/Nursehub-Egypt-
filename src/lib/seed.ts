...
export const seedProducts: Product[] = [
  {
    ...
    titleEn: "Complete Nursing Summaries Bundle (PDF)",
    type: "pdf",
    price: 99,
    oldPrice: 199,
    ...
    descriptionEn: "Over 500 pages of organized summaries covering all nursing subjects.",
    sales: 320,
  },
  {
    id: "p2",
    title: "كورس مهارات التمريض السريرية",
    titleEn: "Clinical Nursing Skills Course",
    type: "course",
    price: 349,
    oldPrice: 599,
    ...
    descriptionEn: "A complete video course teaching clinical skills step by step.",
    sales: 145,
  },
  {
    id: "p3",
    title: "اشتراك بريميوم سنوي",
    titleEn: "Annual Premium Subscription",
    type: "subscription",
    price: 499,
    ...
    descriptionEn: "Unlimited access to all content, courses, and exclusive tools.",
    sales: 89,
  },
];
