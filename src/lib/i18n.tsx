...
const dict = {
  ...
  "drugs.allDrugs": { ar: "كل الأدوية", en: "All Drugs" },
  "drugs.seoDesc": { ar: "دليل أدوية احترافي للممرضين: البحث، التصفية، الترتيب الأبجدي، الجرعات والاعتبارات التمريضية.", en: "A professional drug guide for nurses: search, filtering, alphabetical sorting, dosages and nursing considerations." },
  "drugs.subtitle": { ar: "دواء مع الجرعات والاعتبارات التمريضية", en: "drugs with dosages and nursing considerations" },
  "drugs.browseByCategory": { ar: "تصفّح حسب الفئة", en: "Browse by Category" },
  "drugs.sortAZ": { ar: "أ - ي (تصاعدي)", en: "A - Z (ascending)" },
  "drugs.sortZA": { ar: "ي - أ (تنازلي)", en: "Z - A (descending)" },
  "drugs.highAlertOnly": { ar: "اعرض الأدوية عالية الخطورة فقط", en: "Show high-alert drugs only" },
  "drugs.highAlertOnlyActive": { ar: "بعرض الأدوية عالية الخطورة فقط — اضغط للإلغاء", en: "Showing high-alert drugs only — tap to clear" },
  "drugs.highAlertBadge": { ar: "عالي الخطورة", en: "High Alert" },
  "drugs.adLabel": { ar: "إعلان دليل الأدوية", en: "Drug Guide Ad" },
  "drugs.count": { ar: "دواء", en: "drugs" },
  "mnemonics.pageTitle": { ar: "مذكرات الفارماكولوجي (Mnemonics)", en: "Pharmacology Mnemonics" },
  "mnemonics.pageDesc": { ar: "طريقة سريعة لحفظ معلومات الأدوية المهمة.", en: "quick ways to memorize important drug information." },
  "mnemonics.seoDesc": { ar: "مذكرات (Mnemonics) لتسهيل حفظ أهم معلومات الأدوية والتمريض.", en: "Mnemonics to help memorize key drug and nursing information." },
  "mnemonics.adLabel": { ar: "إعلان المذكرات", en: "Mnemonics Ad" },
  "mnemonics.backToDrugs": { ar: "← العودة لدليل الأدوية", en: "← Back to Drug Guide" },
  "facts.pageTitle": { ar: "المعلومات الصيدلانية", en: "Pharmacy Facts" },
  "facts.libraryTitle": { ar: "مكتبة المعلومات الصيدلانية", en: "Pharmacy Facts Library" },
  "facts.seoDesc": { ar: "مكتبة معلومات صيدلانية وطبية عملية، مقسّمة على 5 فصول.", en: "A practical pharmacy and medical facts library, organized into 5 chapters." },
  "facts.desc": { ar: "مجموعة معلومات وأسئلة وأجوبة صيدلانية عملية، مقسّمة على 5 فصول — كل فصل فيه 100 معلومة.", en: "A collection of practical pharmacy facts and Q&A, organized into 5 chapters — 100 facts each." },
  "facts.availableOf500": { ar: "معلومة متاحة من أصل 500", en: "facts available out of 500" },
  "facts.adLabel": { ar: "إعلان مكتبة المعلومات", en: "Facts Library Ad" },
  "facts.chapterAdLabel": { ar: "إعلان الفصل", en: "Chapter Ad" },
  "facts.chapter": { ar: "الفصل", en: "Chapter" },
  "facts.range": { ar: "المعلومات", en: "Facts" },
  "facts.openChapter": { ar: "افتحي الفصل ←", en: "Open Chapter →" },
  "facts.comingSoon": { ar: "لسه هيتضاف قريب", en: "Coming soon" },
  "facts.backToChapters": { ar: "← كل الفصول", en: "← All Chapters" },
  "facts.toDrugsGuide": { ar: "دليل الأدوية ←", en: "Drug Guide →" },
  "facts.searchPlaceholder": { ar: "ابحثي في معلومات هذا الفصل...", en: "Search this chapter's facts..." },
  "facts.available": { ar: "معلومة متاحة", en: "facts available" },
  "facts.noneUploaded": { ar: "لسه معملتش رفع معلومات الفصل ده.", en: "No facts uploaded for this chapter yet." },
  "facts.noResults": { ar: "مفيش نتائج مطابقة للبحث.", en: "No matching results." },
  "drug.notFound": { ar: "الدواء غير موجود", en: "Drug not found" },
  "drug.backToGuide": { ar: "العودة لدليل الأدوية", en: "Back to Drug Guide" },
  "drug.printCard": { ar: "طباعة بطاقة الدواء", en: "Print Drug Card" },
  "drug.highAlertBadge": { ar: "⚠️ دواء عالي الخطورة", en: "⚠️ High-Alert Medication" },
  "drug.highAlertWarningsHeading": { ar: "تحذيرات دواء عالي الخطورة", en: "High-Alert Medication Warnings" },
  "drug.adLabel": { ar: "إعلان صفحة الدواء", en: "Drug Page Ad" },
  "drug.disclaimer": { ar: "هذه المعلومات لأغراض تعليمية فقط ولا تغني عن استشارة الطبيب أو الصيدلي المختص.", en: "This information is for educational purposes only and does not replace consulting a physician or pharmacist." },
  "drug.knownInteractions": { ar: "🔄 تفاعلات دوائية معروفة", en: "🔄 Known Drug Interactions" },
  "drug.with": { ar: "مع", en: "with" },
  "drug.severitySevere": { ar: "خطير", en: "Severe" },
  "drug.severityModerate": { ar: "متوسط", en: "Moderate" },
  ...
  "drug.highAlertLasa": { ar: "🔤 اسم متشابه (LASA)", en: "🔤 Look-Alike/Sound-Alike (LASA)" },
  "article.beFirstComment": { ar: "كن أول من يعلق على هذا المقال.", en: "Be the first to comment on this article." },
  "article.yourName": { ar: "اسمك", en: "Your name" },
  "article.yourComment": { ar: "تعليقك", en: "Your comment" },
  "article.writeComment": { ar: "اكتب تعليقك...", en: "Write your comment..." },
  "article.submitComment": { ar: "إرسال التعليق", en: "Submit Comment" },
  "article.adInline": { ar: "إعلان داخل المقال", en: "In-article Ad" },
  "article.adSidebar": { ar: "إعلان جانبي (300x250)", en: "Sidebar Ad (300x250)" },
  "search.pageTitleResults": { ar: "نتائج البحث:", en: "Search results:" },
  "search.seoDesc": { ar: "ابحث في المقالات، الكتب، الأدوية والمهارات — عربي وإنجليزي.", en: "Search articles, books, drugs, and skills — Arabic and English." },
  "search.allSections": { ar: "كل الأقسام", en: "All Sections" },
  "search.button": { ar: "بحث", en: "Search" },
  "search.tabAll": { ar: "الكل", en: "All" },
  "search.tabContent": { ar: "المقالات والكتب", en: "Articles & Books" },
  "search.tabDrugs": { ar: "الأدوية", en: "Drugs" },
  "search.tags": { ar: "الوسوم:", en: "Tags:" },
  "search.resultsFor": { ar: "نتائج البحث عن", en: "Search results for" },
  "search.resultWord": { ar: "نتيجة", en: "results" },
  "search.noResultsTryOther": { ar: "لا توجد نتائج مطابقة. جرب كلمات أخرى.", en: "No matching results. Try other keywords." },
  "search.drugsHeading": { ar: "💊 الأدوية", en: "💊 Drugs" },
  ...
  "search.operatingRoomHeading": { ar: "قسم العمليات", en: "Operating Room Nursing" },
  "search.obgynHeading": { ar: "قسم النساء والتوليد", en: "Obstetrics & Gynecology" },
