...
const toOTC = (o: any) => ({ id: o.id, order_num: o.orderNum ?? 0, name_ar: o.nameAr, name_en: o.nameEn, icon: o.icon ?? "🩺", category: o.category, summary: o.summary, symptoms: o.symptoms, key_questions: o.keyQuestions, red_flags: o.redFlags ?? "", treatment: o.treatment, patient_advice: o.patientAdvice ?? "", category_en: o.categoryEn ?? null, summary_en: o.summaryEn ?? null, symptoms_en: o.symptomsEn ?? null, key_questions_en: o.keyQuestionsEn ?? null, red_flags_en: o.redFlagsEn ?? null, treatment_en: o.treatmentEn ?? null, patient_advice_en: o.patientAdviceEn ?? null });
