...
const empty: ExtraSearchIndex = { icuTopics: [], dialysisTopics: [], nicuTopics: [], pharmacologyTopics: [], terminologyTopics: [], firstAidTopics: [], erReceptionTopics: [], protocols: [], lasaPairs: [] };
...
async function loadIndex(): Promise<ExtraSearchIndex> {
  const [icuTopics, dialysisTopics, nicuTopics, pharmacologyTopics, terminologyTopics, firstAidTopics, erReceptionTopics, protocols, lasaPairs] = await Promise.all([
  ...
  return { icuTopics, dialysisTopics, nicuTopics, pharmacologyTopics, terminologyTopics, firstAidTopics, erReceptionTopics, protocols, lasaPairs };
}
