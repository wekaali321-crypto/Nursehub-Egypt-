...
const empty: ExtraSearchIndex = { icuTopics: [], dialysisTopics: [], nicuTopics: [], pharmacologyTopics: [], terminologyTopics: [], firstAidTopics: [], protocols: [], lasaPairs: [] };
...
async function loadIndex(): Promise<ExtraSearchIndex> {
  const [icuTopics, dialysisTopics, nicuTopics, pharmacologyTopics, terminologyTopics, firstAidTopics, protocols, lasaPairs] = await Promise.all([
  ...
  return { icuTopics, dialysisTopics, nicuTopics, pharmacologyTopics, terminologyTopics, firstAidTopics, protocols, lasaPairs };
}
