...
export default function SearchPage() {
  ...
  const { icuTopics, dialysisTopics, nicuTopics, pharmacologyTopics, terminologyTopics, protocols } = useExtraSearchIndex();
  ...
  const total = (showContent ? articleResults.length + icuResults.length + dialysisResults.length + nicuResults.length + pharmacologyResults.length + terminologyResults.length + protocolResults.length : 0) + (showDrugs ? drugResults.length : 0);
