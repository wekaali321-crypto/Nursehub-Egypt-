...
const nav: NavItem[] = [
  ...
  { p: "/admin/obgyn", l: "قسم النساء والتوليد (Obstetrics & Gynecology)", i: "🤰" },
  { p: "/admin/exam-categories", l: "أقسام اختبارات مزاولة المهنة", i: "📜" },
  { p: "/admin/exams", l: "امتحانات مزاولة المهنة", i: "📜" },
  { p: "/admin/exam-questions", l: "أسئلة امتحانات مزاولة المهنة", i: "🧩" },
  ...
  { p: "/admin/ecg-patterns", l: "مكتبة ECG (صور الأنماط)", i: "🖼️" },
  { section: "التفاعل" },
